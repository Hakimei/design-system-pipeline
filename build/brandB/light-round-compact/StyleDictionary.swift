...
public class {
    ...
    public static let colorBrandSecondary = UIColor(red: 0.976, green: 0.976, blue: 0.976, alpha: 1)
    ...
    public static let colorBackgroundPrimary = colorNeutral100
    public static let colorTextPrimary = colorBlack
    public static let colorButtonPrimaryBackground = colorBrandPrimary
    public static let colorButtonPrimaryText = colorBrandSecondary
}