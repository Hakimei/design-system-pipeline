...
public struct Tokens {
    ...
    public static let colorBackgroundPrimary = UIColor(red: 0.094, green: 0.094, blue: 0.094, alpha: 1) // source: {color.dark}
    public static let colorTextPrimary = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1) // source: {color.white}
    public static let colorButtonPrimaryBackground = UIColor(red: 0.898, green: 0.275, blue: 0.400, alpha: 1) // source: {color.brand.primary}
